...
mod entropy_tests {
    ...
    fn test_weight() -> Result<(), McdmError> {
        ...
        let weights = Entropy::weight(&normalized_matrix)?;
...
mod equal_tests {
    ...
    fn test_weight() -> Result<(), McdmError> {
        ...
        let weights = Equal::weight(&matrix)?;
...
mod gini_tests {
    ...
    fn test_weight() -> Result<(), McdmError> {
        ...
        let weights = Gini::weight(&matrix)?;
...
mod standard_deviation_tests {
    ...
    fn test_weight() -> Result<(), McdmError> {
        ...
        let weights = StandardDeviation::weight(&matrix)?;
...
mod variance_tests {
    ...
    fn test_weight() -> Result<(), McdmError> {
        ...
        let criteria_types = CriteriaType::profits(matrix.ncols());
        let normalized_matrix = MinMax::normalize(&matrix, &criteria_types)?;
        let weights = Variance::weight(&normalized_matrix)?;
